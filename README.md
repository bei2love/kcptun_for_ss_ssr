...
```Bash
    wget --no-check-certificate -O ./kcptun_for_ss_ssr-install.sh https://raw.githubusercontent.com/bei2love/kcptun_for_ss_ssr/master/kcptun_for_ss_ssr-install.sh
